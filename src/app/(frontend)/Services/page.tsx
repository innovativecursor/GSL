...
export default function Services() {
  return (
    <div className="bg-white md:mt-20 mt-16 overflow-hidden md:pb-20 pb-12">
      ...
      <div className="mx-4 sm:mx-5 md:mx-[4vw] lg:mx-[10vw] md:mt-16 mt-8">
        ...
        {/* --- 01 --- */}
        <div className="grid md:grid-cols-2 md:gap-x-32 md:gap-y-16 gap-11 md:mt-20 mt-12">
          <div className="flex flex-col md:items-start items-center gap-4">
            <div className="flex-shrink-0 bg-[#FCD33D] text-white font-extrabold text-lg md:text-3xl w-12 h-12 md:w-14 md:h-14 flex items-center justify-center rounded-full">
              01
            </div>
            <div>
              ...
              <div className="list-disc list-inside text-black space-y-2 md:text-sm text-xs tracking-wide">
                ...
                <p className="">
                  ...
                  <span className="">
                    End-to-end supervision to ensure projects are delivered on time and within
                    budget.
                  </span>
                </p>
              </div>
          ...
          <div className="flex flex-col md:items-start items-center gap-4">
            ...
            <div>
              ...
              <div className="list-disc list-inside text-black space-y-3 mt-4 md:text-sm text-xs tracking-wide">
                <p className="">
                  <span className="font-semibold text-gray-600">Residential Homes –</span>
                  <span className="">Modern, sustainable, and functional house designs.</span>
                </p>
      ...
      <div className="mx-0 sm:mx-5 md:mx-[4vw] lg:mx-[10vw] md:mt-16 mt-8">
        <div className="bg-[#FFF9E2] rounded-xl py-8 md:px-10 px-5 mt-16">
